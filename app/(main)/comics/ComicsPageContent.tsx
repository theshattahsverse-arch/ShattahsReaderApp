...
interface ComicsPageContentProps {
  comics: Comic[]
}

export function ComicsPageContent({ comics }: ComicsPageContentProps) {
  ...
  useEffect(() => {
    ...
    if (success === 'true') {
      if (pending === 'true') {
        toast.success(`Plan purchased successfully! Your subscription is being processed.`)
      } else {
        toast.success(`Plan purchased successfully!`)
      }
      // Clean up URL
      router.replace('/comics', { scroll: false })
    }
  }, [searchParams, router])
