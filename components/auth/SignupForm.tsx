...
import { signInWithGoogle, signInWithFacebook, signInWithTwitter, signInWithDiscord, signInWithReddit } from '@/lib/auth-actions'
...
export function SignupForm() {
  ...
  const handleRedditSignIn = async () => {
    ...
    try {
      ...
      setError(err.message || 'An error occurred with Reddit sign in')
      setIsRedditLoading(false)
    }
  }
    ...
    return (
      <Card className="w-full max-w-md border-border/50 bg-card/80 backdrop-blur-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-green-500">Account Created!</CardTitle>
          <CardDescription>
            Welcome to ShattahsVerse! Redirecting you to the multiverse...
          </CardDescription>
        </CardHeader>
      </Card>
    )
  ...
  return (
    <Card className="w-full max-w-md border-border/50 bg-card/80 backdrop-blur-xl">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardTitle className="text-2xl font-bold">Join the Multiverse</CardTitle>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <CardFooter className="flex flex-col space-y-4">
          <Button
            ...
            disabled={isLoading || isGoogleLoading || isFacebookLoading || isTwitterLoading || isDiscordLoading || isRedditLoading}
          >
            {isLoading ? (
              <>
...
{/* 
          ...
          >
            {isRedditLoading ? (
              ...
              <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="#FF4500">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" className="text-amber hover:text-amber-dark hover:underline">
              Sign in
            </Link>
          </p>
        </CardFooter>
